...
def Update(database:str, _where:dict={}, _set:dict={}, _values:dict={}, *, update:bool=True, delete_empty:tuple[bool,str]=False):
    ...
    Args:
        ...
        _values(dict<str,var>): A dictionary of database keys and values to set when no existing case.
            ...
            for key,value in _set.items():
                if type(value) is tuple:
                    if value[1] == "+":
                        ...
                        if debug:print("DEBUG: "+str(_set[key]))
                        if debug:print("DEBUG: "+str(not delete_empty == None))
                        if debug and delete_empty: print("DEBUG: "+str(key==delete_empty[1]))
